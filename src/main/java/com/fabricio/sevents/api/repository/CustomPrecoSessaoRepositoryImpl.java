...
@Repository
public class CustomPrecoSessaoRepositoryImpl implements CustomPrecoSessaoRepository {
...
""";
  ...
  @Override
  public List<PrecoSessaoJoinSessaoResponse> findByIdSessao(UUID idSessao) {
    BeanPropertyRowMapper<PrecoSessaoJoinSessaoResponse> rowMapper = new BeanPropertyRowMapper<>(PrecoSessaoJoinSessaoResponse.class);
