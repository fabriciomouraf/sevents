...
@Repository
public class CustomIngressoRepositoryImpl implements CustomIngressoRepository{
...
""";
    ...
    @Override
    public List<IngressoEventoResponse> findByIdEvento(UUID idEvento) {

        BeanPropertyRowMapper<IngressoEventoResponse> rowMapper = new BeanPropertyRowMapper<>(IngressoEventoResponse.class);
