...
package com.fabricio.sevents.api.util.texto;
...
import com.fabricio.sevents.api.util.numeros.Numeros;
import com.fabricio.sevents.api.util.object.Objeto;
import com.fabricio.sevents.api.util.telefones.Telefones;
...
public class Texto{
     ...
     public static byte[] converteStringHexadecimalEmBytes(String stringHexadecimal) {
          ...
          if (tamanho % 2 != 0) {
               throw new NumberFormatException("O tamanho da string hexadecimal est� incorreto!");
          }
     ...
     public static byte parseByte(String hex) throws NumberFormatException {
          ...
          if (hex == null) {
               throw new IllegalArgumentException("A nota��o hexadecimal est� nula.");
          }
          if (hex.equals("")) {
               return 0;
          }
          ...
          int n = num.intValue();
          if (n > 255 || n < 0) {
               throw new NumberFormatException(" O n�mero " + n + " n�o pode ser convertido em byte!");
          }
     ...
     /**
      * Inclui o caracter informado � esquerda do texto fornecido, at� que este tenha o tamanho desejado
      * 
      * @param texto
     ...
     /**
      * Inclui o caracter informado � direita do texto fornecido, at� que este tenha o tamanho desejado
      * 
      * @param texto
      * O texto que se quer completar
      * @param caracter
     ...
     /**
      * Compara duas Strings sem levar em conta diferen�as entre mai�sculas e min�sculas. Esclui carcteres em branco do in�cio e do fim da String.
      * 
      * @return: boolean
      * @param palavra1
      * @param palavra2
     ...
     /**
      * Verifica se o texto indicado representa um n�mero de telefore v�lido. N�meros de telefone devem possuir 8 d�gitos, opcionalmente separados por um tra�o ('-'). C�digo de �rea
      * (DDD) tamb�m � opcional.
      * 
      * @param texto
      * O texto a ser verificado
      * @return <code>true</code> se o texto for um n�mero de telefone v�lido; caso contr�rio, retorna <code>false</code>.
      */
      ...
      * 
      * @param cpf
      * O CPF o qual deve ter a m�scara removida.
      ...
      * 
      * @param data
      * A DATA a qual deve ter a m�scara removida.
      ...
      * 
      * @param valor
      * O VALOR o qual deve ter a m�scara removida.
      ...
      * 
      * @param cnpj
      * O CNPJ o qual deve ter a m�cara removida.
      ...
      * 
      * @param cep
      * O CEP o qual deve ter a m�scara removida.
      ...
      * 
      * @param cep
      * O CEP o qual a m�scara deve ser colocada.
      ...
      * 
      * @param cnpj
      * O CNPJ o qual a m�scara deve ser colocada.
      ...
      * 
      * @param data
      * A DATA a qual a m�scara deve ser colocada.
      ...
      * 
      * @param cpf
      * O CPF o qual a m�scara deve ser colocada.
      ...
      * 
      * @param texto
      * Texto que ter� o caracter inserido no in�cio.
      * @param c
      * Caracter que ser� inclu�do.
      * @param q
      * Quantidade de vezes que o caracter ser� inclu�do.
      ...
      * 
      * @param texto
      * Texto que ter� as palavras capitalizadas.
     ...
     /**
      * Contar a quantidade de vezes que uma palavra ocorre em um texto. N�o usar caracteres especiais na palavra a ser pesquisada.
      * 
      * @param texto
      * Texto.
      * @param palavra
      * Palavra que ser� contada no texto.
      * @param ignoreCase
      * Considerar mai�sculas ou min�sculas.
     ...
     public static String formata(Object valor, String formato) {
          ...
          try {
               ...
               System.err.println("N�o foi poss�vel aplicar m�scara ao valor: " + valor);
               e.printStackTrace();
               return (String) valor;
          }
     }
     ...
     /**
      * M�todo respons�vel por encriptar um texto usando o algoritmo MD5
      * 
      * @param texto
      * @return
      */
     ...
     /**
      * M�todo respons�vel por reverter um texto
      * 
      * @param texto
